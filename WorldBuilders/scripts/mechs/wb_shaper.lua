...
a.wb_shaper_broken =  a.MechUnit:new{Image = "units/player/wb_shaper_broken.png",   PosX = -22, PosY =  -7 }
a.wb_shaperw_broken = a.MechUnit:new{Image = "units/player/wb_shaper_w_broken.png", PosX = -20, PosY =  -3 }
